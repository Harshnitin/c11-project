...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(windowWidth/2-300,windowWidth/2+300),40, 10, 10));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(windowWidth/2-300,windowWidth/2+300),40, 10, 10));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(windowWidth/2-300,windowWidth/2+300),40, 10, 10));
